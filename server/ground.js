...
function searchDocuments(documents, query) {
  ...
  const documentContents = documents.map(doc => doc.sectionTree + ' ' + doc.lang + ' ' + doc.code);
...
// Example usage
const documents = [
  { path: 'doc3', sectionTree: 'Java Advanced', lang: 'java', code: 'class MyClass implements MyInterface {}' },
  { path: 'doc1', sectionTree: 'Java OOP', lang: 'java', code: 'public interface MyInterface {}' },
  { path: 'doc2', sectionTree: 'Python Intro', lang: 'python', code: 'def my_function():' },
];

const query = 'java interface';
